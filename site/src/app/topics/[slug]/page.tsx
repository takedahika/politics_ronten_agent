      ...
      <div className="container">
        ...
        <div className="newsletter-cta animate-in">
          <div className="newsletter-cta-inner">
            <p className="newsletter-cta-eyebrow">✍️ このトピックの背景を読む</p>
            {newsletterArticles.length > 0 ? (
              <>
                <p className="newsletter-cta-body">
                  このトピックは、ニュースレター「<strong>1年に3日だけ政治を考える</strong>」のエッセイから生まれました。
                  AIが継続的に情報を収集・整理する論点ページとあわせて、ぜひ読んでみてください。
                </p>
                <div className="newsletter-cta-links">
              ...
              <p className="newsletter-cta-body">
                政治について、週に一度だけ、じっくり考えるニュースレターです。
                このトピックの背景にある問いを、著者の視点で読むことができます。
              </p>
            )}
            <a
    ...
    <article className="topic-page">
      <div className="container">
        ...
        <section className="topic-section" style={{ borderTop: "1px solid var(--border)", paddingTop: "2rem" }}>
          ...
          <a
            href={`https://github.com/YOUR_USERNAME/ronten-no-genzaichi/commits/main/topics/${slug}`}
            target="_blank"
            rel="noopener noreferrer"
            style={{
              display: "inline-block",
